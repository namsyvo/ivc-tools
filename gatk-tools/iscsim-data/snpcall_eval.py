...
data_path = sys.agrv[1] #"/home/SNP/GRCh37_human"
index_path = sys.argv[2] #data_path + "/index"
genome_path = sys.argv[3] #data_path + "/chr20_mutate1/genome"
result_path = sys.argv[4] #data_path + "/chr20_mutate1/results/4-1-2014-GATK"
...
result_file_path = sys.argv[5] # result_path + "/prec-rec.txt"
