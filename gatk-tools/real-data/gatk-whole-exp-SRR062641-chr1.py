...
cmd = "time " + prog_path + "/bwa bwasw " + index_path + "/GRCh37_chr1.fasta " \
    + reads_path + "/SRR062641_1.fastq " + reads_path + "/SRR062641_2.fastq > " + results_path + "/SRR062641-chr1.sam"
print cmd
os.system(cmd)
...
cmd = "time " + script_path + "/gatk-preprocess-real-data.sh " + ref_path + "/GRCh37_chr1 " \
	+ sam_path + "/SRR062641-chr1 " + tool_path
os.system(cmd)
...
cmd = "time " + script_path + "/gatk-callsnp.sh " + ref_path + "/GRCh37_chr1.fasta " \
	+ sam_path + "/SRR062641-chr1_sorted_RG.bam " \
	+ ref_path + "/ALL.chr1.integrated_phase1_v3.20101123.snps_indels_svs.genotypes-diffcontigname.vcf " \
	+ results_path + "/SRR062641-chr1.vcf " + tool_path
os.system(cmd)

result_path = "/data/nsvo/Human/SRS006837/results"
script_path = "/home/nsvo/workspace/isc-scripts/gatktools"

cmd = "go run " + script_path + "/extract-alt-vcf.go " + result_path + "/SRR062641-chr1.vcf > " \
	+ result_path + "/SRR062641-chr1.vcf.txt"
os.system(cmd)
...
snp = {}
called_snp_file = result_path + "/SRR062641-chr1.vcf.txt"
...
result_file_path = result_path + "/SRR062641-chr1-gatk-eval.txt"
