...
ref_len = 492449994 #chr1+2
read_lens = [100]
seq_errs = ['0.00015-0.0015']
read_nums = [cov*ref_len/(2*read_lens[0]) for cov in [1, 5, 10]]
for rl in read_lens:
	for err in seq_errs:
		for rn in read_nums:
			ref_path = "/data/nsvo/test-data/GRCh37_chr1_chr2/refs/af_sid_mutant/mutant_genome.fasta"
			result_path = "/data/nsvo/test-data/GRCh37_chr1_chr2/reads/sim-reads/af_sid_mutant_dwgsim"
