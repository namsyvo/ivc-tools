...
confi_arr = [n for n in range(50)]

for seq_err in ['0.02', '0.04']:
	result_snp_file_path = result_path + "/prec-rec-snp-rsc-human-" + str(seq_err) + ".txt"
	result_snp_file = open(result_snp_file_path, "w")

	result_indel_file_path = result_path + "/prec-rec-indel-rsc-human-" + str(seq_err) + ".txt"
