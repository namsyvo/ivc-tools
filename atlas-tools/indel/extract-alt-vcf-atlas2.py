...
data_path = "/backup/qmtran/Atlas_Indel2"
#result_path = data_path + "/human"
result_path = data_path + "/soybean-test"
...
#	for seq_err in ['0.01', '0.02', '0.04']:
		cmd = "go run " + script_path + "/extract-alt-vcf.go " + result_path + "/reads-100." + seq_err + "." + cvr + ".atlas2-indel.vcf > " \
