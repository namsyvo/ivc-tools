...
result_path = os.path.join(data_path, result_dir, "atlas")
...
for rl in read_lens:
    for err in seq_errs:
        for rn in read_nums:
            ...
            called_var_file = result_path + "/" + prefix_fn + ".bwa_sorted_RG_realign_Noknown_SNP.vcf"
            called_var = {}
