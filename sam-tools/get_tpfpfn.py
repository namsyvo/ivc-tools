'''
Extract TP, FP, and FN from SNP call results of samtools
...
for para in ref_para[:1]:
    ...
    result_dn = os.path.join(data_path, result_dir, "samtools_realign")
    ...
    for rl in read_lens:
        for err in seq_errs:
            for rn in read_nums:
                ...
                called_var_file = os.path.join(result_dn, fn_part + ".bwa_sorted_RG_realign_Noknown.norm.vcf")
