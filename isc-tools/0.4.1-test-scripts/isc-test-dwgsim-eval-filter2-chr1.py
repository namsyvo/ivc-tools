        ...
        for err in seq_errs:
            for rn in read_nums:
                for ms in max_snum[6:7]:
                    ...
                    total_snp_num = len(sorted_snp)
                    print sorted_snp[total_snp_num - 300000]
                    snp_num = 0
                    for key, value in sorted_snp:
                        aln_dis = int(value[4])
                        chr_dis = int(value[5])
                        if key in true_snp_comp or key in true_indel_comp or len(value[0]) > 1:
                            #if chr_dis < 700 and chr_dis > 100:
                            ...
                            if snp_num > expected_snp_num:
                                ...
                                if aln_dis <= 1 and chr_dis < 600 and chr_dis > 200:
                                    ...
                                    called_snp[key] = value
                            '''
                            if snp_num > total_snp_num - 200000:
                                if aln_dis <= 1:
                                    called_snp[key] = value
                                    snp_num += 1
                            elif snp_num > total_snp_num - 300000:
                                if aln_dis <= 2:
                                    called_snp[key] = value
                                    snp_num += 1
                            else:
                                #if chr_dis < 650 and chr_dis > 150:
                                if aln_dis <=3:
                                    called_snp[key] = value
                                    snp_num +=1
