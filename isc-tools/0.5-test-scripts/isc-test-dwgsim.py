...
cmd = "python isc-0.5.4-dwgsim-eval-diff-pos.py " + config_file + " 1.14 " + cpu_num + " " + cov_num + " " + prog_version + "-" + time_stamp
print cmd
os.system(cmd)
#cmd = "python isc-test-dwgsim-eval-all-pos.py " + config_file + " 1.14 " + cpu_num + " " + cov_num + " " + prog_version + "-" + time_stamp
#print cmd
#os.system(cmd)
