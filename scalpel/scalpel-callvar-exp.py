...
for rl in read_lens:
    for err in seq_errs:
        for rn in read_nums:
            ...
            cmd = "/usr/bin/time -v " + prog_path + "/scalpel-discovery  --single --ref " + ref_file + " --bed " + bed_file + " --bam " + bam_file + " --dir " + result_dir + " --window 600 --numprocs 32 2>" + result_dir + "/scalpel_run.log"
            print cmd
            os.system(cmd)
